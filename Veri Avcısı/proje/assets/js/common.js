				...
				$.ajax({
					...
					beforeSend: function () {
						Swal.fire({
							...
							html: 'Mesajınız gönderiliyor.Lütfen bekleyiniz.',// add html attribute if you want or remove
					...
					success: function (response) {
						...
						Swal.fire({
							...
							html: 'En kısa sürede sizinle iletişime geçeceğiz.',// add html attribute if you want or remove
							showConfirmButton: false,
							timer: 2000
						});
						$("#cform").reset();
